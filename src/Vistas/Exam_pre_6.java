 ...
 * @author Usuario
 */
public class Exam_pre_6 extends javax.swing.JFrame {

    /**
     * Creates new form Exam_pre_6
     */
    int cantidad,seccion;
    public Exam_pre_6(int cant,int sec) throws Exception {
        initComponents();
        cantidad = cant;
        seccion = sec;
        cargarDatos();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Exam_pre_6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new Exam_pre_6().setVisible(true);
            }
        });
    }
