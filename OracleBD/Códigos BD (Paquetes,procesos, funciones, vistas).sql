...
--------------------------------------------------------------------------------
CREATE OR REPLACE PACKAGE PACK_MANAGE_TEACHER AS
  ...
  FUNCTION GET_TEACHER (code_teacher IN TEACHER.CODETEACHER%TYPE)
  RETURN type_cursor;
  FUNCTION GET_TEACHERS
  RETURN type_cursor;
END PACK_MANAGE_TEACHER;

CREATE OR REPLACE PACKAGE BODY PACK_MANAGE_TEACHER IS
  ...
  RETURN type_cursor
  IS
  cursor1 PACK_MANAGE_TEACHER.type_cursor;
  BEGIN
    OPEN cursor1 FOR
