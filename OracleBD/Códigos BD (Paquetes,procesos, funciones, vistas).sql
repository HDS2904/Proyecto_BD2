...
CREATE OR REPLACE PACKAGE PACK_MANAGE_PERSONS AS
  ...
  FUNCTION SEARCH_D (dni_p PERSON.DNI%TYPE) RETURN type_cursor;
...
CREATE OR REPLACE PACKAGE PACK_MANAGE_SECTIONS AS
  ...
  PROCEDURE INSERT_D (id_s SECTION.ID_SUBJECT%TYPE, id_p SECTION.ID_PERSON%TYPE,
  id_ex SECTION.ID_EXAM%TYPE, sec_g SECTION.SECTION_GROUP%TYPE);
  PROCEDURE UPDATE_D (id_se SECTION.ID_SECTION%TYPE, id_s SECTION.ID_SUBJECT%TYPE, 
  id_p SECTION.ID_PERSON%TYPE, id_ex SECTION.ID_EXAM%TYPE, sec_g SECTION.SECTION_GROUP%TYPE);
...
CREATE OR REPLACE PACKAGE BODY PACK_MANAGE_SECTIONS IS
  ...
  id_ex SECTION.ID_EXAM%TYPE, sec_g SECTION.SECTION_GROUP%TYPE)
    IS
    BEGIN
      INSERT INTO SECTION (ID_SUBJECT, ID_PERSON, ID_EXAM, SECTION_GROUP) VALUES (id_s, id_p, id_ex, sec_g);
      commit;
      EXCEPTION
      WHEN OTHERS THEN
      rollback;
  ...
  id_p SECTION.ID_PERSON%TYPE, id_ex SECTION.ID_EXAM%TYPE, sec_g SECTION.SECTION_GROUP%TYPE)
    IS
    BEGIN
      UPDATE SECTION SET ID_SUBJECT = id_s, ID_PERSON = id_p, ID_EXAM = id_ex, SECTION_GROUP = sec_g
