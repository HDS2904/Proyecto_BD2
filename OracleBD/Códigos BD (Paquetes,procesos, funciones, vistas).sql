...
create or replace 
PACKAGE PACK_MANAGE_QUESTION_EXAMS AS
  ...
  FUNCTION LIST_D RETURN type_cursor;
  FUNCTION SEARCH_QU (id_ex question_exam.id_exam%TYPE,id_n question_exam.n_question%TYPE) RETURN type_cursor;
END PACK_MANAGE_QUESTION_EXAMS;

create or replace 
PACKAGE BODY PACK_MANAGE_QUESTION_EXAMS IS
  PROCEDURE INSERT_D (id_e QUESTION_EXAM.ID_EXAM%TYPE, ques QUESTION_EXAM.QUESTION%TYPE, n_ques QUESTION_EXAM.N_QUESTION%TYPE)
    IS
    BEGIN
  ...
  END LIST_D;
   FUNCTION SEARCH_QU (id_ex question_exam.id_exam%TYPE,id_n question_exam.n_question%TYPE) RETURN type_cursor
    ...
    BEGIN
      OPEN cursor1 FOR
      SELECT * FROM QUESTION_EXAM WHERE id_exam = id_ex and n_question = id_n;
      RETURN cursor1;
  END SEARCH_QU;  
END PACK_MANAGE_QUESTION_EXAMS;
